...
- **[QuTiP](https://github.com/qutip/qutip)** — 用于量子系统模拟的开源框架，在量子光学、量子信息及相关计算物理研究中被广泛使用。
- **[QuTiP-qip](https://github.com/qutip/qutip-qip)** — QuTiP 生态中的量子信息处理项目，聚焦量子线路层面的模拟与相关工作流支持。
